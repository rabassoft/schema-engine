...
- **Estado:** Promoted; ADR-026 revision 0 and coordinated ADR-018 revision 6
  ...
  passed review 176 cycle 7 and await protected branch/PR publication
...
1. **M22 repository delivery:** PLAN-024 checkpoints 1–7 están completos.
   Checkpoint 8 settings pasan review 176 ciclo 7; la siguiente acción es
   publicar la evidencia por rama corta/CI/PRs protegidas. npm permanece gated.
