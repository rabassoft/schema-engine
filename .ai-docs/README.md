...
- [PLAN-024 checkpoint 8 settings preflight](./reviews/176-plan-024-checkpoint-8-preflight-review.md)
  ...
  settings boundary. Protected branch/PR publication remains gated.
...
- [ADR-026: Sanitized public history and secure release automation](./adrs/026-public-repository-and-secure-releases.md)
  ...
  checkpoints 1–7 are complete and checkpoint 8 settings passed review 176
  cycle 7 before protected publication.
...
- [PLAN-024: Sanitized public repository and secure-release preparation](./plans/024-sanitized-public-repository.md) — Approved revision 0; checkpoints 1–7 are complete and checkpoint 8 settings passed review 176 cycle 7 before protected branch/PR publication
