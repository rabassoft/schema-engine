...
- _Positivas:_ Rendimiento sobresaliente de renderizado en árboles complejos. _Bundle_ mínimo para el consumidor.
- _Negativas:_ Requiere que los consumidores utilicen versiones recientes del framework Angular (16+) que soporten la API de Signals.
