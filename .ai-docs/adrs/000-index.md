...
18. [ADR 018: Dual AGPL/commercial licensing and public experimental publication](./018-licencia-dual-publicacion-experimental.md) — **Accepted revision 6 coordinated with ADR-026 after review 166 cycle 3; M21 remains exact and M22 implementation is inactive.**
...
26. [ADR 026: Sanitized public history and secure release automation](./026-public-repository-and-secure-releases.md) — **Accepted revision 0 after review 166 cycle 3; preserves sanitized reachable history and public `.ai-docs`, with PLAN-024 preparation only authorized.**
