...
- _Positivas:_ Experiencia de instalación impecable. Permite a la librería estar siempre a la vanguardia tecnológica.
- _Negativas:_ Mayor complejidad en la automatización del CI/CD para las publicaciones.
