...
- Crear una única librería monolítica de UI con múltiples configuraciones. Descartada por engordar el _bundle size_ innecesariamente.

**6. Consecuencias:**

- _Positivas:_ Separación de responsabilidades perfecta. Permite que otras empresas utilicen nuestro Core para inyectar sus propias librerías internas de componentes.
