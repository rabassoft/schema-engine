...
native HTML renderers for the root-object and primitive-field subset defined by
SPEC-001. It does not own domain data, validation, persistence, submit flows, or
runtime behavior.
